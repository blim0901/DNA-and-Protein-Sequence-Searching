In this project, we are required to propose and analyse a brute force algorithm to search for the exact occurrence of a query sequence in a nucleic acid sequence. However, due to the slow implementation of the algorithm for large genome sequences, we aim to improve the running time of the search by designing the following string-matching algorithms: Brute Force Algorithm / Improved Brute force algorithm / Knuth-Morris-Pratt algorithm
